...
![](images/hex/workflows.png){.absolute top="120" left="425" width="150"} 
...
![](images/hex/embed.png){.absolute top="466" left="300" width="150"} 

![](images/hex/finetune.png){.absolute top="333" left="1126" width="150"} 

![](images/hex/butcher.png){.absolute top="470" left="500" width="150"} 
